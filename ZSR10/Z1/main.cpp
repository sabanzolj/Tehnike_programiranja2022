...
class Sat{
    ...
    Sat(int temp){sekunde=temp;minute=0;sati=0;PostaviNormalizirano(sati, minute, sekunde);}
    Sat(int hh,int mm,int ss){sati=hh;minute=mm;sekunde=ss;PostaviNormalizirano(sati, minute, sekunde);}
